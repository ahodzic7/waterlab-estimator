...
%% ================================================ Load Data ================================================
data = dataLoad('Lab_Data_CCTA_15Dec_v1.mat');                                    % Load simulation data 
startDataIndex = 1; 
endDataIndex = 8000;%size(data,2);
%% ================================================ Prepare Data =============================================
...
N_optimization_variables = N_statesb;
...
Q(3,:) = uConv(data(13,startDataIndex:endDataIndex), ["", "1/minTo1/s"]);
input = [Q(1,:)' Q(2,:)' Q(3,:)'];
...
if N_augmented_states > 0
    ...
    modelName = 'free_flow_model_CCTA21'
else
